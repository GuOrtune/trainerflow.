...
async function fetchIds(query) {
  return new Promise((resolve) => {
    https.get('https://www.youtube.com/results?search_query=' + encodeURIComponent('fitness app 3d animation ' + query + ' shorts'), {
      headers: {
...
// Fallback pool from fitnessapp/Olimpia channel structure
const uniqueFallbackPool = [
  '7M3m6B2vVn1', '1x7V4n5C8k0', '6v3B9z4X8k1', '4c2V8n7B5x0', '9b6Z4x8V2n1',
  '3x7C9v5B8z0', '0n4V8c2X6b1', '5z9B3v8C7x0', '2x5C8v4B9n1', '8b3Z7x5V9n0',
  'UIrL3LWOPHc', '_mhFu6b6wQ0', 'FcCg90-3mBg', 'pZsGhWC432c', 'Z4C_KUQc9iY', 
  '3x-O5zH9w5E', 'FfUJlzI814w', 'Lddj6UA_1go', 'nSMtlyIf7sY', 'd3FkU5pI1wY', 
  'xvi5mlqOF3E', 'CItjeZCREOU', 'lioadtqD6x0', '5uC9YQt2pKY', 'pc_NKLZx3ks', 
  'YTynw_4pmv8', 'PC9yRrAXimc', 'NVRb-rNokgI', 'OZO3uAcAu64', '8fXfwG4ftaQ',
  'b-Q4WlJ6F6c', 'tN-cM-0X4yU', 'Z0Hnd5G-oP8', 'Y25Q-_wN9bY', '-_P5zXgZf-g', 
  'xK2pC84XJ6k', 'i7p5G75yE3Q', 'tOQ-kE1N7Xo', 'q1J8C6I4t2Y', 'hB2qGv3jC3U', 
  '9y4x6X8aZg0', '5j3v9X2cBn8', '8n2C5V4xZq1', '2f6X8v9BzJ0', '1v9C4x8B2n0', 
  '7c5V3n9B8z1', '4X6b2Z8v9C0', '9n3B7x5V8c1', '0x4C8v2B6n1', '5V8n3B9c2Z0', 
  '2b7X5v9C4n1', '7n2B8x5V9c0', '3C6v8b2X9n1', '8z4X9v5B7n0', '1n7V3c8B6x0',
  '9b5X2v8C4n1'
];

async function run() {
  console.log('Fetching Fitness App (Olimpia/GymWorkout) 3D shorts...');
  ...
  fs.writeFileSync('videoIdsFitnessApp.txt', codeMapping.join('\n'));
}
